...
class FelMegaprint(models.Model):
    ...
    firma_fel = fields.Char('Firma Fel', copy=False, readonly=True, )
    serie_fel = fields.Char('Serie Fel', copy=False, readonly=True)
    numero_fel = fields.Char('Numero Fel', copy=False, readonly=True)
    ...
    pdf_uri = fields.Char('PDF Fels', copy=False, help="Valida PDF.", readonly=True)
    uuid_contigencia = fields.Char('Numero de acceso', copy=False,
                                   help="Numero de acceso para facturar en contingencia.", readonly=True)
    ...
    motivo_anula_fel = fields.Char('Motivo de anulación',
                                   ...
                                   readonly=False)
    tipo_doc_fel = fields.Char('Tipo documento', copy=False, help="Este campo indica el tipo de documento generado.",
                               readonly=True)
    ...
    codigo_escenario = fields.Char(string='Codigo de escenario FEL',
    ...
    def dteDocumento(self):
        ...
        print("DTE_NS--------", DTE_NS)
        print("factura.journal_id.direccion_fel.codigo_establecimiento--------",
              factura.journal_id.direccion_fel.codigo_establecimiento)
