    ...
    def invoice_fel(self):
        ...
        for factura in self:
            ...
            if factura.uuid_contigencia:
                raise UserError("El documento fue creado en contingencia, no puede certificarse de forma normal, debe esperar que el Sistema procese automaticamente.")
        ...
        if result:
            ...
            for factura in self:
                ...
                if factura.estado_doc_fel == 'Anulado':
                    raise UserError("El documento fue Anulado anteriormente, por lo que no puede ser Anulado nuevamnte.")
